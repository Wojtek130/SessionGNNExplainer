...
dir = "explanation_files_long_training_rerun_modify_session_embeddings/"
k = 100
epochs = 12000
for i, filename in enumerate(session_data):
    ...
    for j, s in enumerate(sessions):
        file_path = os.path.join(dir, f"explanation_b{batch_no}_s{j}_modify_session_embeddings.json")
